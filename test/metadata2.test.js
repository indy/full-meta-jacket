...
exports['scopedBuild index.html'] = function() {
  ...
  assert.eql(scoped._filename, "/index.imd");
...
exports['scopedBuild journal/a1.html'] = function() {
  ...
  assert.eql(scoped._filename, "/journal/_posts/a1.imd");
...
exports['scopedBuild journal/c3.html'] = function() {
  ...
  assert.eql(scoped._filename, "/journal/_posts/c3.imd");
...
exports['scopedBuild for simple content'] = function() {
  ...
  assert.eql(scoped._filename, '/simple/simple.html');
