...
//  console.log(scopedMeta._filename);
...
function renderWithLayout(hb, scopedMeta) {
  ...
  mergedMeta.content = imbue.render(mergedMeta, body, mergedMeta._useMarkdown);
  ...
  do {
    ...
    mergedMeta.content = imbue.render(mergedMeta, body, false);
