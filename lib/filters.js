...
exports.publicFilters = { 
  listEachWith: function(arr, snip) {
    return wrapTag("ul", renderPartials(arr, snip));
  },
  reverseListEachWith: function(arr, snip) {
    var reversedList = arr.slice(0).reverse();
    return wrapTag("ul", renderPartials(reversedList, snip));
  },
  renderEachWith: function(arr, snip) {
